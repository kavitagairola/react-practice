...
function Living() {
  ...
  const goToAbout = () => {
    navigate("/furnituree"); // ✅ route must match <Route />
  };

  return (
    <>
      <div className="flex flex-col lg:flex-row mt-4 gap-4" onClick={goToAbout}>
        <div className={`relative flex justify-center ${imageWrapperClass}`}>
          ...
          />
          <button className="absolute top-10 left-4 bg-white text-gray-800 px-4 py-2 rounded shadow-lg">
            LIVING ROOM
          </button>
        </div>
